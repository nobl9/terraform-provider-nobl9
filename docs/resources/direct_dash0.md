---
page_title: "nobl9_direct_dash0 Resource - terraform-provider-nobl9"
description: |-
  Dash0 Direct | Nobl9 Documentation https://docs.nobl9.com/Sources/dash0#dash0-direct.
---

# nobl9_direct_dash0 (Resource)

Dash0 is an observability platform that provides real-time monitoring and insights. Nobl9 connects to Dash0 for SLI measurement collection and comparison with SLO targets.

For more information, refer to [Dash0 Direct | Nobl9 Documentation](https://docs.nobl9.com/Sources/dash0#dash0-direct).
...
- `auth_token` (String, Sensitive) [required] | Dash0 API Auth Token.
